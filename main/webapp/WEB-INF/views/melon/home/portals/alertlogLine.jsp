...
<!-- 为ECharts准备一个具备大小（宽高）的Dom -->
    <div class="home-portal-body" id="main_alert" style="width:100%;height:100%;"></div>
<script type="text/javascript">
var oldTime = new Date();//记录首次时间
var isAdd = true;

function searchAlertByTime(date,obj){
	var end  = date;
	...
	searchEs.groupByName(null,"las-alert","type","",start,end,10,function(array){
		var count = 0;
...
// 			    },
          ...
          require(["echarts/chart/line", "echarts/chart/bar"], function() {
      		 var myChart = mc.Echarts.init(document.getElementById("main_alert"));
           
          
          // 为echarts对象加载数据 
          myChart.setOption(option); 
           searchAlertByTime(date.getTime(),myChart);
          ...
          timeTicket = setInterval(function (){
        	  var dd = new Date();
              logdata = searchAlertByTime(dd.getTime(),myChart);
