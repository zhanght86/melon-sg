...
<div class="page-query-body" style="width:100%;">
	<mh:grid id="assetGroup" 
			 queryUrl = "asset/group/listByType?typePath=${typePath }"
			 showUrl="asset/group/show"
			 hasPages= "true" 
			 var="assetGroupConfig">
		...
		<mh:col name="netType" index="netType" title="asset.assetGroup.netType" width="15"/>
		<mh:col name="useState" index="useState" title="asset.group.useState" width="15"/>
	</mh:grid>
</div>
