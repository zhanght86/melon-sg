...
<div class="col-xs-4 tree-left">
	...
	<mh:tree id="group" 
			 rootId="1"
			 url="asset/group/find?rootId=${rootId }"
			 sortName="order"
			 scriptSelf="false">
	</mh:tree> 
</div>
...
$(function(){
	var byEnviGridUrl = "<c:url value='/asset/device/byDomainGrid/'/>", 
	...
	btnSearch.on("click",function(event){
		groupTree.search($.trim(searchName.val()));
		event.preventDefault();
	});
	
	//菜单资源选择注册
	groupTree.onSelect(function(data) {
		assetForm.load(byEnviGridUrl + data.path); //加载修改页面 
	});
