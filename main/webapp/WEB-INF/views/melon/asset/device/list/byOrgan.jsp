...
<mh:section id="basic">
	...
	<jsp:attribute name="title">
		<fmt:message key="asset.device.organInfo">
		    <fmt:param><strong>${devices[0].organName}</strong></fmt:param>
		    <fmt:param><label style="color:#45a6d6">${fn:length(devices)}</label></fmt:param>
		</fmt:message>
		<a href="<c:url value='/asset/device/export?organId=${devices[0].organId }'/>" class = "btn btn-primary" style="float:right;">
		...
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					...
					<th><fmt:message key="asset.abstract.domainName" /></th>
