...
<div class="page-query-body" style="width:100%;">
	<mh:grid id="device" 
			 queryUrl = "asset/device/listByDomain?domainPath=${domainPath }"
			 showUrl = "asset/device/show"
			 hasPages= "true" 
			 var="deviceConfig">
		<mh:col name="name" index="A_NAME" title="asset.abstract.name" width="28"/>
		<mh:col name="code" index="A_CODE" title="asset.abstract.code" width="22"/>
		<mh:col name="chargeName" index="CHARGER_NAME" title="asset.abstract.chargeName" width="20"/>
		<mh:col name="organName" index="ORGAN_NAME" title="asset.abstract.organName" width="15"/>
		<mh:col name="using" index="US_ING" title="asset.abstract.using" width="15"/>
	</mh:grid>
</div>
