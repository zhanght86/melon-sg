...
function (angular, app, _, kbn, moment) {
  ...
  module.controller('table', function($rootScope, $scope, $modal, $q, $compile, $timeout,
    ...
    $scope.panelMeta = {
      ...
      status: "Stable",
      description: "一个可以分页显示你查询结果的控件. 单击一行"+
        "可以展开并显示所有与当前有个的字段值 <p>"
    };
    ...
    $("#myModal").on("hiden.bs.modal", function(event) {
     ...
     * by Gan Huan
     */
    $scope.find_corrIds = function(key, value) {
    	if(key == "correlationIds") {
    		var url = Kibana.rootUrl + "/elasticsearch/queryAlertById?ids="+value;
