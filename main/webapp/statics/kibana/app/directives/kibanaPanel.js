      ...
      '<div class="panel-header">'+
        '<div class="row-fluid">' +
          '<div class="span12 alert-error panel-error" ng-hide="!panel.error">' +
            ...
            '<i class="icon-exclamation-sign"></i> <strong>出错了!</strong> {{panel.error}}' +
          '</div>' +
        '</div>\n' +
        ...
        '<div class="row-fluid panel-extra">' +
          '<div class="panel-extra-container">' +
            ...
            '<span class="extra row-button" ng-show="panel.editable != false && panel.removable != false">' +
              ...
              '<i class="icon-remove pointer" bs-tooltip="\'删除\'"></i></span>'+
            '</span>' +

            '<span class="extra row-button" ng-hide="panel.draggable == false">' +
              '<span class="pointer" bs-tooltip="\'拖拽\'"' +
            ...
            '<span class="row-button extra" ng-show="panel.editable != false">' +
              ...
              '<i class="icon-cog pointer" bs-tooltip="\'配置\'"></i></span>'+
            '</span>' +

            '<span class="row-button extra" ng-show="panel.editable != false">' +
              '<span ng-click="duplicate_panel(panel)" class="pointer">'+
              '<i class="icon-copy pointer" bs-tooltip="\'复制\'"></i></span>'+
            '</span>' +
