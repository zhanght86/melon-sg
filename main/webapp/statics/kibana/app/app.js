...
function (angular, $, _, appLevelRequire) {
  ...
  app.config(function ($routeProvider, $controllerProvider, $httpProvider, $compileProvider, $filterProvider, $provide) {
    ...
    $routeProvider
      .when('/connectionFailed', {
        templateUrl:  Kibana.baseUrl + 'app/partials/connectionFailed.html',
      })
      .when('/dashboard', {
        templateUrl: Kibana.baseUrl + 'app/partials/dashboard.html',
      })
   ...
   * 作为基本的依赖模块
   */
	_.each(['controllers', 'directives', 'factories', 'services', 'filters'], function(type) {
  ...
  app.panel_helpers = {
    partial: function (name) {
      return Kibana.baseUrl + 'app/partials/'+name+'.html';
    }
  };
