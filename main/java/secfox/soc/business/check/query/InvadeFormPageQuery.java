 ...
 * @version 1.0
 */
public class InvadeFormPageQuery extends PageQuery<InvadeFormSearchForm> {
	...
	@Override
	protected InvadeFormSearchForm initSearchForm() {
		InvadeFormSearchForm vf=new InvadeFormSearchForm();
		return vf;
	}
